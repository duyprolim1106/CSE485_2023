...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th2 27, 2023 lúc 04:53 AM
...
CREATE TABLE `baiviet` (
  `ma_bviet` int(220) UNSIGNED NOT NULL,
...
CREATE TABLE `tacgia` (
  `ma_tgia` int(220) UNSIGNED NOT NULL,
...
CREATE TABLE `theloai` (
  `ma_tloai` int(220) UNSIGNED NOT NULL,
...
CREATE TABLE `users` (
  `id_ngdung` int(220) UNSIGNED NOT NULL,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `btth01_cse485`.`vw_music`  AS SELECT `btth01_cse485`.`baiviet`.`ma_bviet` AS `ma_bviet`, `btth01_cse485`.`baiviet`.`tieude` AS `tieude`, `btth01_cse485`.`baiviet`.`ten_bhat` AS `ten_bhat`, `btth01_cse485`.`theloai`.`ten_tloai` AS `ten_tloai`, `btth01_cse485`.`tacgia`.`ten_tgia` AS `ten_tgia` FROM ((`btth01_cse485`.`baiviet` left join `btth01_cse485`.`theloai` on(`btth01_cse485`.`baiviet`.`ma_tloai` = `btth01_cse485`.`theloai`.`ma_tloai`)) left join `btth01_cse485`.`tacgia` on(`btth01_cse485`.`baiviet`.`ma_tgia` = `btth01_cse485`.`tacgia`.`ma_tgia`))  ;
...
--
ALTER TABLE `baiviet`
  MODIFY `ma_bviet` int(220) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT cho bảng `tacgia`
--
ALTER TABLE `tacgia`
  MODIFY `ma_tgia` int(220) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `theloai`
--
ALTER TABLE `theloai`
  MODIFY `ma_tloai` int(220) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT cho bảng `users`
--
ALTER TABLE `users`
  MODIFY `id_ngdung` int(220) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
